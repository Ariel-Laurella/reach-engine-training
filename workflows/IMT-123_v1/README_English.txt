...
This workflow is intended to ingest in Reachengine all the contents of a file directory admitted by the system, as well as the automatic catalogue of the metadata by means of a sheet in CSV format in a single execution step.
